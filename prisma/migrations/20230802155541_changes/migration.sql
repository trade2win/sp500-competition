...
CREATE TABLE "new_Prediction" (
    ...
    CONSTRAINT "Prediction_user_id_week_year_fkey" FOREIGN KEY ("user_id", "week", "year") REFERENCES "WeeklyScore" ("user_id", "week", "year") ON DELETE RESTRICT ON UPDATE CASCADE
);
